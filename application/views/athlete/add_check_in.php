            ...
            <div class="row align-items-center py-2">
                <div class="col-lg-6 col-7">
                    ...
                    <nav aria-label="breadcrumb" class="d-none d-md-inline-block ml-md-4">
                        ...
                        <li class="breadcrumb-item"><a href="<?php echo base_url().$this->session->userdata('type')?>/check_in">Check In</a></li>
          ...
          <div class="card">
            <div class="card-body">
              ...
              <form id="adCheckIn">
                ...
                <input type="hidden" name="csdate" value="<?php echo $csdate;?>"/>
                <input type="hidden" name="cedate" value="<?php echo $cedate;?>"/>
