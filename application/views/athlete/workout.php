        ...
        <div class="header-body">
            <div class="row align-items-center py-2">
                <div class="col-lg-6 col-7">
                    <h6 class="h2 text-dark d-inline-block mb-0">Workout</h6>
                    <nav aria-label="breadcrumb" class="d-none d-md-inline-block ml-md-4">
                        ...
                        <li class="breadcrumb-item"><a href="<?php echo base_url()?>athlete/workouts">Workout</a></li>
          ...
          <div class="card">
            <div class="card-header">
              <div class="row align-items-center">
                <div class="col-8">
                  <h3 class="mb-0">Workout information</h3>
                </div>
              </div>
            </div>
            <div class="card-body">
