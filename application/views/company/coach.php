        ...
        <div class="header-body">
            <div class="row align-items-center py-4">
                <div class="col-lg-6 col-7">
                    <h6 class="h2 text-white d-inline-block mb-0">Coach</h6>
                    <nav aria-label="breadcrumb" class="d-none d-md-inline-block ml-md-4">
                        ...
                        <li class="breadcrumb-item active" aria-current="page"><a href="<?php echo base_url()?>company/coach">Coach</a></li>
                        </ol>
                    </nav>
                </div>
                <div class="col-lg-6 col-5 text-right">
                    <a href="<?php echo base_url()?>company/coach/add" class="btn btn-sm btn-neutral">Add</a>
                </div>
            </div>
        </div>
    </div>
        ...
        <div class="col">
          <div class="card">
            ...
            <div class="table-responsive">
              <table id="dtabel" class="table align-items-center table-flush">
