            ...
            <div class="row align-items-center py-2">
                <div class="col-lg-6 col-7">
                    ...
                    <nav aria-label="breadcrumb" class="d-none d-md-inline-block ml-md-4">
                        ...
                        <li class="breadcrumb-item active" aria-current="page"><a href="<?php echo base_url()?>coach/shows">Forms</a></li>
                        </ol>
                    </nav>
                </div>
                <div class="col-lg-6 col-5 text-right">
                    <a href="<?php echo base_url()?>company/forms/add" class="btn btn-secondary">Add</a>
                </div>
            </div>
        </div>
    </div>
        ...
        <div class="col">
          <div class="card">
            ...
            <!-- Light table -->
              ...
              <table id="formsDataTable" class="table align-items-center table-flush">
