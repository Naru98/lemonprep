            ...
            <div class="row align-items-center py-2">
                <div class="col-lg-6 col-7">
                    ...
                    <nav aria-label="breadcrumb" class="d-none d-md-inline-block ml-md-4">
                        ...
                        <li class="breadcrumb-item"><a href="<?php echo base_url().$this->session->userdata('type')?>/athlete">Athlete</a></li>
        ...
        <div class="col-md-12 mx-auto">
          <div class="card card-profile mt-5">
            ...
            <ul class="nav nav-pills nav-fill flex-column flex-sm-row" id="tabs-text" role="tablist">
              ...
              <li class="nav-item">
                <a class="nav-link mb-sm-3 mb-md-0 <?php if($snav==2){ echo 'active'; } ?>" id="tabs-text-2-tab" href="<?php echo base_url('company/athlete/view/'.$id.'/2');?>" role="tab" aria-controls="tabs-text-2" aria-selected="false">Nutrition</a>
              </li>
              <li class="nav-item">
